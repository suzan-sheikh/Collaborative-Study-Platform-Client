...
const ResponsiveMenu = ({ showMenu, setShowMenu }) => {
  ...
  const user = {displayName: 'md Suzan Sheikh', photoURL: 'https://lh3.googleusercontent.com/-XdP66AzzK1c/AAAAAAAAAAI/AAAAAAAAAAA/ALKGfklTvdIuR6-9cxcX9GmXLM9IDRvYCg/photo.jpg?sz=46'  }
  ...
  return (
    <div
      ...
      } fixed bottom-0 top-0 z-50 flex h-screen w-[75%] flex-col justify-between bg-white px-8 pb-6 pt-4 text-white transition-all duration-200 md:hidden rounded-r-xl shadow-md`}
    >
      <div className="card">
