      ...
      <div className="flex justify-center items-center mx-auto my-4 container px-4 mt-20">
        <div className="flex w-full max-w-sm mx-auto overflow-hidden rounded-lg shadow-lg lg:max-w-4xl bg-[#006961] bg-no-repeat bg-cover">
          <div className="w-full px-6 py-8 md:px-8 mx-auto">
            ...
            <form>
                <div className="">
                    <textarea name="" id="" className="w-full h-20 p-2" placeholder="Enter Your Review..."></textarea>
                </div>
                ...
                <div className="flex flex-col md:flex-row justify-between mt-2">
                <button
                    className="mx-auto text-xl px-6 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gradient-to-r from-[#41CF9F] to-[#3B82F6] hover:from-[#3B82F6] hover:to-[#41CF9F] rounded-lg focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50"
                >
                    Submit Now
                </button>
                </div>
