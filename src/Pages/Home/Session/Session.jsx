        ...
        <div className="container mx-auto px-4 py-3 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="flex flex-col justify-center items-center gap-2 p-2 py-6 border-[1px] rounded-3xl border-[#003AAA] hover:bg-[#003AAA] hover:text-white transition ease-in-out delay-150">
                    ...
                    <span className="px-6 py-1 bg-[#42CE9F] inline-block">Close</span>
                    <Link to='/session-details' className="font-medium hover:underline">Read More</Link>
                </div>               
            </div> 
            <div>
            <button className="border-[1px] border-[#003AAA] hover:bg-[#003AAA] hover:text-white py-1 px-3 font-medium text-black transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">READ MORE</button>
            </div>           
        </div>
    );
};
